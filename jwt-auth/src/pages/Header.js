  ...
  return (
    <>
      ...
      <nav className="navbar navbar-expand-lg navbar-light text-white" id="navbar" style={{ background: '#131921' }}>
        ...
        <Link to='/' className="text-white"><div className="w-75 d-flex border rounded p-1" style={{ justifyCOntent: 'center', alignItems: 'center' }}> <HiOutlineLocationMarker color="white" size="1.5em" /><span className="pl-lg-1 m-0" style={{ lineHeight: '19px' }}><small>Deviver to</small> <b>India</b></span></div> </Link>
        ...
        <div className=" dropdown">
          <button className="dropbtn dropdown-toggle" style={{ width: '55px' }}><img src={Flag} className='w-100' /></button>
